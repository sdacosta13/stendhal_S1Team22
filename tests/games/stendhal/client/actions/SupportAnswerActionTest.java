	...
	public void testExecute() {
		new MockStendhalClient() {
			...
			public void send(final RPAction tell) {
				assertEquals("supportanswer", tell.get("type"));
				assertEquals("schnick", tell.get("target"));
				assertEquals("something", tell.get("text"));
		...
		final SlashAction action = SlashActionRepository.get("supportanswer");
